...
std::vector<double> solve_primal(const RetailSolution& solution, const RetailProblem& problem) {
...
//  RetailSolver direct_solver(operations_research::MPSolver::SCIP_MIXED_INTEGER_PROGRAMMING, problem, false);
//  RetailSolution direct_solution = direct_solver.Solve();
